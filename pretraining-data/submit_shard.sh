...
# Wrapper script to submit a pretraining data preparation job with dynamic shard ID
...
# Set log directory
LOG_DIR="/sphinx/u/salt-checkpoints/yodas2-mm-pretrain/logs"
...
echo "Submitted pretraining data preparation job for shard: ${SHARD_ID}"
