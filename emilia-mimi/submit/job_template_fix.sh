...
#SBATCH --output=/sphinx/u/salt-checkpoints/emilia-mm-pretrain-fix/logs/default.log
#SBATCH --error=/sphinx/u/salt-checkpoints/emilia-mm-pretrain-fix/logs/default.log
...
if [ -z "$SHARD_ID" ]; then
    ...
    echo "Usage: sbatch submit/job_template_fix.sh <shard_id>"
    echo "Example: sbatch submit/job_template_fix.sh EN-B000000"
    exit 1
fi
...
WORK_DIR="/sphinx/u/salt-checkpoints/emilia-mm-pretrain-fix/cache-dir"
...
python -u process_shard_fix.py \
    --split Emilia \
    --shard-id ${SHARD_ID} \
    --work-dir /sphinx/u/salt-checkpoints/emilia-mm-pretrain-fix/work-dir \
    --cache-dir /sphinx/u/salt-checkpoints/emilia-mm-pretrain-fix/cache-dir
