...
def process_shard(
    ...
    output_dataset = Dataset.from_dict({
        ...
        "speaker_id": [item["speaker_id"] for item in combined_data],
        "chapter_id": [item["chapter_id"] for item in combined_data],
    })
...
if __name__ == "__main__":
    main()
    # Example usage:
    # python process_libritts_r.py --shard-id train.clean.100-00000-of-00018 --hf-repo-id potsawee/libritts-r-mm-pretrain
    # python process_libritts_r.py --shard-id-list shard_list.txt --hf-repo-id potsawee/libritts-r-mm-pretrain
